                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()) {
                            ...
                            if (!userInvite) {
                                ...
                                String currentUserId = currentUser.getUid(); // Lấy ID của người dùng hiện tại
                                if (!currentUserId.equals(sCode)) {
...
//                                                                    Toast.makeText(NhapMaActivity.this, "Cập nhật userEnergy thành công", Toast.LENGTH_SHORT).show();
                                    ...
                                    // Người dùng nhập mã của chính họ
                                    Toast.makeText(NhapMaActivity.this, "Bạn không thể nhập mã của chính bạn.", Toast.LENGTH_SHORT).show();
                                }
